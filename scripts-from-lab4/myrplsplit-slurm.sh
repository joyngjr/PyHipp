...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:664418968343:awsnotify --message "job start"
...
aws sns publish --region ap-southeast-1 --topic-arn arn:aws:sns:ap-southeast-1:664418968343:awsnotify --message "JobDone"
