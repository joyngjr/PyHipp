...
#SBATCH -J "rpllfa"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rpllfa-slurm.%N.%j.out # STDOUT
#SBATCH -e rpllfa-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:664418968343:awsnotify --message "FSJobDone"
